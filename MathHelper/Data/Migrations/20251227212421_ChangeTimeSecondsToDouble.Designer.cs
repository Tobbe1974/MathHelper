...
namespace MathHelper.Migrations
{
    ...
    [Migration("20251227212421_ChangeTimeSecondsToDouble")]
    partial class ChangeTimeSecondsToDouble
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MathHelper.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("MathHelper.Models.TrialResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("TrialResults");
                });

            modelBuilder.Entity("MathHelper.Models.UserProgress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MathHelper.Models.TrialResult", b =>
                {
                    b.HasOne("MathHelper.Data.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MathHelper.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
